...
export default function ContentContainer({
  ...
  return (
    <div className={`${visible && !disabled ? 'visible' : 'invisible'}`}>
      <div className="fixed top-0 bottom-0 right-0 flex flex-row items-center h-screen overflow-auto transition ease-in-out border border-gray-600 bg-slate-100 z-max">
        <div className="flex flex-col self-stretch bg-slate-100">
